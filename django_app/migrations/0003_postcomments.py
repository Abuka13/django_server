...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('django_app', '0002_delete_complaints'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(max_length=200, on_delete=django.db.models.deletion.CASCADE, to='django_app.suggests', verbose_name='К какому посту')),
            ],
            options={
